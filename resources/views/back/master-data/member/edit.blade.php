...
@section('header')
    <header class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Perbaharui Client</h1>
            </div>

            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.master_data.categories.index') }}">Client</a>
                    </li>
                    <li class="breadcrumb-item active">Perbaharui Client</li>
                </ol>
            </div>
        </div>
    </header>
...
@section('content')
    <div class="content-body">
        <form id="form-validation" action="{{ route('admin.master_data.members.update', [$member]) }}" method="POST">
            @csrf
            @method('PATCH')
            <div class="card">
                <div class="card-body form-row">
                    ...
                    <section class="col-lg-6 form-group">
                        ...
                        <select name="category" class="form-control" id="categorySelect" required>
                            ...
                            <option value="Personal" {{ $member->category == 'Personal' ? 'selected' : '' }}>Personal</option>
                            <option value="Company" {{ $member->category == 'Company' ? 'selected' : '' }}>Company</option>
                        </select>
                    </section>
                    ...
                    <section class="col-lg-6 form-group" id="companyNameInput" style="display: none">
                        ...
                        <input type="text" class="form-control" name="company_name" value="{{ $member->company_name }}">
                    </section>
