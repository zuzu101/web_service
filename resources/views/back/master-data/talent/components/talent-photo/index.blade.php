...
<section class="card">
    <article class="card-header">
        <div class="float-right">
            <div class="btn-group">
                <a href="{{ route('admin.master_data.talents.talent_photo.create', $talent) }}" class="btn btn-success"><i class="fa fa-plus"></i></a>
            </div>
        </div>
    </article>
    ...
    $(function() {
        $('#datatable').DataTable({
            ...
            ajax: {
                ...
                url: "{{ route('admin.master_data.talents.talent_photo.data', [$talent]) }}",
                dataType: "json",
                type: "POST"
            },
            columns: [
