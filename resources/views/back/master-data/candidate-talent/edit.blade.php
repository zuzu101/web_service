        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Perbaharui Calon Talent</li>
                </ol>
            </div>
        </div>
    </header>
...
@section('content')
    <div class="content-body">
        <form method="POST" action="{{ route('admin.master_data.candidate-talents.update', $talent->id) }}" enctype="multipart/form-data">
            <div class="card">
                <div class="card-body">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <select class="form-control mb-3" name="rate_call_day" required>
                                ...
                                <option value="0" {{ $talent->talentRate->call_day ?? '' == 0 ? 'selected' : '' }}>Minggu</option>
                                <option value="1" {{ $talent->talentRate->call_day ?? '' == 1 ? 'selected' : '' }}>Senin</option>
                                <option value="2" {{ $talent->talentRate->call_day ?? '' == 2 ? 'selected' : '' }}>Selasa</option>
                                <option value="3" {{ $talent->talentRate->call_day ?? '' == 3 ? 'selected' : '' }}>Rabu</option>
                                <option value="4" {{ $talent->talentRate->call_day ?? '' == 4 ? 'selected' : '' }}>Kamis</option>
                                <option value="5" {{ $talent->talentRate->call_day ?? '' == 5 ? 'selected' : '' }}>Jum'at</option>
                                <option value="6" {{ $talent->talentRate->call_day ?? '' == 6 ? 'selected' : '' }}>Sabtu</option>
                            </select>
